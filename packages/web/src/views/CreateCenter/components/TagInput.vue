<template>
    <div class="tag-input-panel">
        <div class="tag-list">
            <el-tag class="tag-item" v-for="tag in modelValue" :key="tag" closable :disable-transitions="false"
                @close="handleClose(tag)">
                {{ tag }}
            </el-tag>
        </div>
        <div class="tag-input">
            <el-input placeholder="按回车键Enter创建标签" v-model="inputValue" :maxlength="15" resize="none" show-word-limit
