    ...
    <div class="video-detail">
        <div class="video-header">
            ...
            <div class="video-user-info">
                ...
                <div class="user-info">
                    <router-link class="nick-name" :to="`/user/${userInfo.id}`" target="_blank">{{ userInfo.nickName
                        }}</router-link>
                    ...
                    <div class="op-btns">
                        ...
                        <div class="focus-btn">
                            ...
                            <el-button class="btn" type="primary" @click="focusUser(1)" v-else>关注 {{ userInfo.fansCount
                                }}</el-button>
                        </div>
                    </div>
                </div>
